...
function renderCard(t, role) {
    ...
    if (isCoord) {
        ...
        footer = _empFooter(t, hasReview, isPending);
    }
...
function _empFooter(t, hasReview, isPending) {
...
function _assigneeCoord(t) {
    if (t.assignee && t.assignee.trim()) {
        return `<span style="color:#0f766e;font-weight:700;display:flex;align-items:center;gap:6px;flex-wrap:wrap">
            ${t.assignee}
